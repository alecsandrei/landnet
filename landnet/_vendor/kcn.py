"""Vendored from https://github.com/jmj2316/KAN_CNN/blob/main/kcn.py."""
...
class ConvNeXtKAN(nn.Module):
    def __init__(self, convnext: nn.Module):
        ...
        width = 1024
        self.kan1 = KANLinear(num_features, width, **kwargs)
        self.kan2 = KANLinear(width, out_features, **kwargs)
